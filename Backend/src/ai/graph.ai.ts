...
const judgeNode: GraphNode<typeof state> = async (state) => {
    ...
    const judge = createAgent({
        ...
        systemPrompt: `You are a judge tasked with evaluating two solutions generated by different AI models. First, generate your own ideal theoretical solution to the problem. Then, please provide a score out of 10 for each AI solution, along with your reasoning for the scores compared to your ideal solution.`
    })
